...
public class PnlQuanLyNhanVien extends JPanel {
    ...
    private final JButton btnPhanQuyen =
            AdminTheme.createActionButton("Phân quyền", AdminTheme.ButtonRole.NEUTRAL);
    ...
    private JPanel buildForm() {
        ...
        // Hàng 1
        addFormRow(form, lc, fc, 1, 0, "Phòng ban", cbPhongBan);
        addFormRow(form, lc, fc, 1, 2, "Chức vụ", cbChucVu);
        addFormRow(form, lc, fc, 1, 4, "Trạng thái", cbTrangThai);
    ...
    private void add() {
        try {
            ...
            nhanVienBUS.themNhanVienVaTaiKhoan(nv, username, password, nhomQuyenId);
    ...
    private NhanVienDTO getFormData(Integer id) {
        ...
        // 3 cột này giữ trong DB nhưng không nhập ở form
    ...
    // ✅ Hàm reload tổng hợp để gọi từ Listener
